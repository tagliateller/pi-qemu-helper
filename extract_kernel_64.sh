...
#
# --------------------------------------------------------------------------
#cp: cannot stat '/tmp/qemuhelper.QGJqGb/kernel.img': No such file or directory
#cp: cannot stat '/tmp/qemuhelper.QGJqGb/bcm2708-rpi-zero.dtb': No such file or directory
